        ...
        <div className="row">
            ...
            <Block>
             ...
             <h2 id="mainHeader">Bem vindo a Won Games</h2>
              ...
              <P>Ao lado você pode inserir diferentes jogos, categorias e publishers
                 para nossa maravilhosa loja de jogos</P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
                <h2>Veja nosos links!</h2>
              <P style={{ paddingRight: 7, paddingBottom: 0 }}>
                Em caso de duvidas e ou sujestões, só ir em algum de nossos links
              </P>
